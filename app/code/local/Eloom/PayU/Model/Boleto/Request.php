...
class Eloom_PayU_Model_Boleto_Request extends Mage_Core_Model_Abstract {
  ...
  public function generatePaymentRequest(Mage_Sales_Model_Order $order) {
    ...
    $parameters = array(
        ...
        Eloom_PayU_Util_PayUParameters::PAYMENT_METHOD => Eloom_PayU_Api_PaymentMethods::BOLETO_BANCARIO,
