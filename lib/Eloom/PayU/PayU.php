 ...
 *
 */
abstract class Eloom_PayU_PayU {
   ...
   * Api name
   */
  const API_NAME = "PayU SDK"; // FIXME: trocar
  const API_CODE_NAME = "PAYU_SDK"; // FIXME: trocar
   ...
   */
  public static $language = Eloom_PayU_Api_SupportedLanguages::PT;

}

/** validates Environment before begin any operation */
Eloom_PayU_Api_Environment::validate();
