...
class Eloom_PayU_Api_PayUKeyMapName {
	...
	const ORDER_ID = Eloom_PayU_Util_PayUParameters::ORDER_ID;
	
	/** property name to the reference code to api request */
	const REFERENCE_CODE = Eloom_PayU_Util_PayUParameters::REFERENCE_CODE;
	
	/** property name to the transaction id to api request */
	const TRANSACTION_ID = Eloom_PayU_Util_PayUParameters::TRANSACTION_ID;
